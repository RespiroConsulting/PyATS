...
class Removenetwork_testcase(aetest.Testcase):
    @ aetest.test
    def remove_network(self):
        bgpsummarydevice1 = device1.configure("router bgp 65000\n"
                                              "no network 10.200.0.0 mask 255.255.0.0")
        log.info("network is removed")
        time.sleep(60)
...
class Addnetwork_testcase(aetest.Testcase):
    @ aetest.test
    def add_network(self):
        bgpsummarydevice1 = device1.configure("router bgp 65000\n"
                                              "network 10.200.0.0 mask 255.255.0.0")
        log.info("network is added")
